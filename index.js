...
client.on('message', async (message) => {
  ...
  if (message.content.toLowerCase().includes('hi ') || message.content.toLowerCase().includes('hello ') || (message.content == 'hi') || (message.content == 'hello')) {
    ...
    var emojis =[' 👋', ' 😀','',' 😃',' 😄',' 😁',' 🙂',' 🙃',' 😉',' 😊',' 🥰',' ☺️',' 😋',' 🤗',' 😎',' 🤠',' 🥳',' 💩',' 🤡',' 👻',' 😺',' 😸',' 👶',' 🧒',' 👦',' 👧', ' 🧑',' 👱',' 👨', ' 🧔',' 🧔',' 👨‍🦰',' 👨‍🦱',' 👨‍🦳',' 👨‍🦲',' 👩',' 👩‍🦰',' 🧑‍🦰',' 👩‍🦱',' 🧑‍🦱',' 👩‍🦳',' 🧑‍🦳',' 👩‍🦲',' 👱‍♀️',' 👱‍♂️',' 🧓',' 👴',' 👵',' 🧑‍⚕️',' 👨‍⚕️',' 👩‍⚕️',' 🧑‍🎓',' 👨‍🎓',' 👩‍🎓',' 🧑‍🏫',' 👨‍🏫',' 👩‍🏫',' 🧑‍⚖️',' 👨‍⚖️',' 👨‍⚖️',' 👩‍⚖️',' 👋', ' 😀','',' 😃',' 😄',' 😁',' 🙂',' 🙃',' 😉',' 😊',' 🥰',' ☺️',' 😋',' 🤗',' 😎',' 👋', ' 😀','',' 😃',' 😄',' 😁',' 🙂',' 🙃',' 😉',' 😊',' 🥰',' ☺️',' 😋',' 🤗',' 😎',' 👋', ' 😀','',' 😃',' 😄',' 😁',' 🙂',' 🙃',' 😉',' 😊',' 🥰',' ☺️',' 😋',' 🤗',' 😎',' 👋', ' 😀','',' 😃',' 😄',' 😁',' 🙂',' 🙃',' 😉',' 😊',' 🥰',' ☺️',' 😋',' 🤗',' 😎',' 👋', ' 😀','',' 😃',' 😄',' 😁',' 🙂',' 🙃',' 😉',' 😊',' 🥰',' ☺️',' 😋',' 🤗',' 😎',' 👋', ' 😀','',' 😃',' 😄',' 😁',' 🙂',' 🙃',' 😉',' 😊',' 🥰',' ☺️',' 😋',' 🤗',' 😎','','','','','','','','','','','ඞ','','','','','','','','','','','','','','','',''];
